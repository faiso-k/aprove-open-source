...
/**
 * @author cryingshadow
 * Contains all relevant nodes in a derivation graph for complexity analysis.
 */
public class CpxNodeSets {
     ...
     * @param pNodes The parallel nodes.
    ...
    public CpxNodeSets(
        ...
        final Set<Node<PrologAbstractState>> pNodes,
