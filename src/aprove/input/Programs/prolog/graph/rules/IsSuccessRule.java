 ...
 * @version $Id$
 */
public class IsSuccessRule extends AbstractInferenceRule {
     ...
     */
    public IsSuccessRule(final PrologSubstitution s, final Pair<PrologTerm, PrologTerm> e) {
        this.substitution = s;
        this.evaluation = e;
    }
    ...
    public String prettyToString() {
        return "IS SUCCESS" + this.getSubstitution() == null ? "" : "\\n" + this.getSubstitution().prettyToString();
    }

    @Override
    public AbstractInferenceRules rule() {
        return AbstractInferenceRules.IS_SUCCESS;
    }
