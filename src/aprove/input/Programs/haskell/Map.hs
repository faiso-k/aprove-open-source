...
deleteFindMin t 
  = case t of
      ...
      Tip             -> (error "",Tip) --(error "Map.deleteFindMin: can not return the minimal element of an empty map", Tip)
...
deleteFindMax t
  = case t of
      ...
      Tip             -> (error "",Tip) --(error "Map.deleteFindMax: can not return the maximal element of an empty map", Tip)
