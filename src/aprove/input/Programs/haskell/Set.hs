...
deleteFindMin t 
  = case t of
      ...
      Tip           -> (error "",Tip) --"Set.deleteFindMin: can not return the minimal element of an empty set", Tip)
...
deleteFindMax t
  = case t of
      ...
      Tip           -> (error "",Tip) --"Set.deleteFindMax: can not return the maximal element of an empty set", Tip)
