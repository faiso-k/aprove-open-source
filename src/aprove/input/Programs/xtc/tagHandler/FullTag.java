...
public class FullTag implements TagHandler<XTCTagNames> {

    private RawTrs rawtrs;

    public FullTag(RawTrs rawtrs) {
        this.rawtrs = rawtrs;
    }
    ...
    @Override
    public void finish() {
        this.rawtrs.setConstructorbased(false);
    }

    @Override
    public void setAttributes(Attributes attributes) {
        if (attributes.getLength() != 0) {
            throw new IllegalTagAttributeException(XTCTagNames.full,
