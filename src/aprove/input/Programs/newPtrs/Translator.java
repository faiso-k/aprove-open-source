...
import aprove.input.Generated.newPtrs.*;
...
public class Translator extends TranslatorSkeleton {
    ...
    public void translate(Reader reader) {
        try {
        	newPtrsLexer lex = new newPtrsLexer(new ANTLRReaderStream(reader));
            CommonTokenStream tokens = new CommonTokenStream(lex);
            newPtrsParser parser = new newPtrsParser(tokens);
            RawPtrs rawptrs = parser.trs();
