...
class OblCreatorEtrs {
    ...
    public static Set<FunctionSymbol> buildSymColl(Collection<FunctionSymbol> symNames) {
        final Set<FunctionSymbol> funcSymbColl = new LinkedHashSet<FunctionSymbol>();
        for (final FunctionSymbol stringFuncSymb : symNames) {
            funcSymbColl.add(stringFuncSymb);
        }
        return funcSymbColl;
    }
