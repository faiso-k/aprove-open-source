...
public class LLVMInconsistentState extends LLVMAbstractState {

    public LLVMInconsistentState(
   ...
   public LLVMSymbolicEvaluationResult postProcessAfterEvaluation(Set<? extends LLVMRelation> rels, boolean removeNonLiveVariables, Abortion aborter) {
    ...
    public LLVMInconsistentState setVarToEntryStateVarsMap(ImmutableMap<LLVMSymbolicVariable,ImmutableSet<LLVMSymbolicVariable>> entryStateVarCorrespondenceMap) {
