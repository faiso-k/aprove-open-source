...
import aprove.*;
import aprove.input.Generated.xsrs.lexer.*;
import aprove.input.Generated.xsrs.node.*;
import aprove.input.Generated.xsrs.parser.*;
import aprove.input.Utility.*;
import aprove.verification.oldframework.Input.*;
import aprove.verification.oldframework.Rewriting.*;
import aprove.verification.oldframework.Syntax.*;

/** ProgramTranslator for translating XSRS programs into internal representation.
...
public class Translator extends ProgramTranslator {
    ...
    private static Program predefine(Program prog) {
        try {
            ...
            throw new RuntimeException("Internal error building predefined symbols for XSRS");
        }
