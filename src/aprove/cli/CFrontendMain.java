...
public class CFrontendMain extends FrontendMain<CFrontendMain.CFrontendOpts> {
    /**
     * Record-like class holding all options for this frontend.
     */
    static class CFrontendOpts extends aprove.cli.FrontendMain.FrontendOpts {
        /** JSON Graph export. */
        boolean jsonExport = false;
    }

    @Override
    CFrontendOpts createFrontendOpts() {
    ...
    Getopt createGetopt(final List<LongOpt> longoptsArg, final String[] argv) {
        ...
        return new Getopt("AProVE C Frontend", argv, "hs:o:t:g:j:", longopts.toArray(new LongOpt[0]));
    }
