...
public class PfSub<I extends IntRing<I>> extends BinaryIntFunction<I, I> {

    public PfSub(final ImmutableList<? extends IntegerDomain<I>> domains) {
        super(PredefinedFunction.Func.Sub, domains, true);
    }
    ...
    protected ITerm<I> intEvaluate(final I val1,
        ...
        return val1.subtract(val2).getTerm(predefinedMap);
    }
