...
public class PfBwand<I extends IntRing<I>> extends BinaryBitwiseIntFunction<I> {

    public PfBwand(final ImmutableList<? extends IntegerDomain<I>> domains) {
    ...
    protected ITerm<I> intEvaluate(final I val1,
        ...
        return val1.bitwiseAnd(val2).getTerm(predefinedMap);
    }
