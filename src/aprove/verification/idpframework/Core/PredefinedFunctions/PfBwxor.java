...
public class PfBwxor<I extends IntRing<I>> extends BinaryBitwiseIntFunction<I> {

    public PfBwxor(final ImmutableList<? extends IntegerDomain<I>> domains) {
    ...
    protected ITerm<I> intEvaluate(final I val1,
        ...
        return val1.bitwiseXor(val2).getTerm(predefinedMap);
    }
