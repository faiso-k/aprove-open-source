...
public class CIdtPolyIntRedPairImplicationGraph implements IDPExportable {
    ...
    public CIdtPolyIntRedPairImplicationGraph(final IDPProblem idp) {
        ...
        for (final IEdge edge : this.idpGraph.getEdges()) {
            ...
            for (final ItpfConjClause preconditionClause : precondition.getClauses()) {
                ...
                if (edge.type.isInf()) {
                    conclusionLiterals.put(itpfFactory.createEdgeOrientation(
                        edge, preconditionClause, RelDependency.Increasing,
                        IActiveCondition.EMPTY_CONDITION,
                        ISubstitution.emptySubstitution(), toSubstitution,
                        EdgeOrientationRelation.ABSTRACT_COMPLEXITY_WEAK_GT),
                        true);
                    ...
                    conclusionLiterals.put(itpfFactory.createEdgeOrientation(
                        ...
                        IActiveCondition.EMPTY_CONDITION,
                        ISubstitution.emptySubstitution(), toSubstitution,
                        EdgeOrientationRelation.ABSTRACT_STRICT_BOUND), true);
                }
