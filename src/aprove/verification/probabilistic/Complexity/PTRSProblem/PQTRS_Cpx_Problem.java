 ...
 * @version $Id$
 */
public class PQTRS_Cpx_Problem extends DefaultBasicObligation implements Immutable {
     ...
     */
    public PQTRS_Cpx_Problem(final Set<ProbabilisticRule> probabilisticRules,
        final QTermSet Q,
     ...
     */
    private PQTRS_Cpx_Problem(final ImmutableSet<ProbabilisticRule> probabilisticRules,
        final QTermSet Q,
     ...
     * @param R
     */
    public static PQTRS_Cpx_Problem create(final ImmutableSet<ProbabilisticRule> PR,
        final QRewriteStrategy strat,
        final boolean basic) {
        return PQTRS_Cpx_Problem.create(PR, new QTermSet(new ArrayList<>(0)), strat, basic);
    }
    ...
    public static PQTRS_Cpx_Problem create(final ImmutableSet<ProbabilisticRule> PR,
        ...
        final QRewriteStrategy strat,
        final boolean basic) {
        return PQTRS_Cpx_Problem.create(PR, new QTermSet(Q_it), strat, basic);
    }
    ...
    public static PQTRS_Cpx_Problem create(final ImmutableSet<ProbabilisticRule> PR,
        ...
        final QRewriteStrategy strat,
        final boolean basic) {
        return new PQTRS_Cpx_Problem(PR, Q, strat, basic);
    }
     ...
     * @param adpp
     */
    public PQTRS_Cpx_Problem createUsableRulesSubProblem(final ADP_Cpx_Problem adpp) {
        ...
        return new PQTRS_Cpx_Problem(usableRules, this.Q, qSuperR, getProbQUsableRulesCalculator(adpp.getBiAnnoMap()), adpp.getStrat(), adpp.isBasic());
    }
     ...
     */
    public PQTRS_Cpx_Problem createSubProblem(final ImmutableSet<ProbabilisticRule> rules) {
        if (Globals.useAssertions) {
            assert (this.PR.containsAll(rules));
        }
        return new PQTRS_Cpx_Problem(rules, this.Q, this.strat, this.basic);
    }
     ...
     */
    public PQTRS_Cpx_Problem create(final QTermSet Q) {
        if (Q.getTerms().equals(this.Q.getTerms())) {
            return this;
        }
        return new PQTRS_Cpx_Problem(getPR(), Q, this.strat, this.basic);
    }
    ...
    public boolean equals(final Object oth) {
        ...
        final PQTRS_Cpx_Problem other = (PQTRS_Cpx_Problem) oth;
