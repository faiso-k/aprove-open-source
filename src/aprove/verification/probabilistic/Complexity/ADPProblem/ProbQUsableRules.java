...
public class ProbQUsableRules {
    ...
    private final PQTRS_Cpx_Problem pqtrs;
    ...
    public ProbQUsableRules(final PQTRS_Cpx_Problem qtrs, final BidirectionalMap<FunctionSymbol, FunctionSymbol> annoMap) {
        this.pqtrs = qtrs;
    ...
    public PQTRS_Cpx_Problem getUnderlyingPQTRS() {
        return this.pqtrs;
    }
