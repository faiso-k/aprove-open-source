 ...
 * @version $Id$
 */
public class ADP_Cpx_UsableTermsProcessor extends ADP_Cpx_ProblemProcessor {
    ...
    public boolean isCpxADP_Applicable(final ADP_Cpx_Problem qdp) {
        ...
        final ProbComplexityDependencyGraph graph = qdp.getDependencyGraph();
    ...
    protected Result processCpxADPProblem(final ADP_Cpx_Problem qdp, final Abortion aborter) throws AbortionException {
        ...
        final ADP_Cpx_Problem newProblem = ADP_Cpx_Problem.create(newP, newS, newK, qdp.getSwithQ(), qdp.getStrat(), qdp.isBasic(), qdp.getBiAnnoMap());

        final CpxADP_UsableTermsProof utProof = new CpxADP_UsableTermsProof(unusableTermsSet);

        return ResultFactory.proved(newProblem, UpperBound.create(), utProof);
    }
    ...
    public static class CpxADP_UsableTermsProof extends ADP_SAST_Proof {

        private final Set<TRSFunctionApplication> unusableTermsSet;

        private CpxADP_UsableTermsProof(final Set<TRSFunctionApplication> unusableTermsSet) {
        ...
        public String export(final Export_Util o, final VerbosityLevel level) {
            ...
            res.append("The approximation of the Dependency Graph "); // Add Citation
            res.append(" gives us the following unusable Terms: ");
            res.append(o.linebreak());
            res.append(o.set(this.unusableTermsSet, Export_Util.NICE_SET));
            res.append(o.linebreak());
            res.append("Hence, as part of the dependency graph processor,")
                .append(" we can remove the annotations from these terms ")
                .append("from every RHS of every ADP in P and S.");
            res.append(o.linebreak());
