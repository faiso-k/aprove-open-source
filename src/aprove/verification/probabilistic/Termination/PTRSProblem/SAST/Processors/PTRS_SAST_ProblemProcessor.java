 ...
 * @version $Id$
 */
public abstract class PTRS_SAST_ProblemProcessor extends Processor.ProcessorSkeleton {
    ...
    public boolean isApplicable(final BasicObligation o) {
        if (o instanceof final PTRSProblem ptrs) {
            if (ptrs.getTarget() != ProbabilisticTerminationResult.SAST) {
                return false;
            }
    ...
    public Result process(final BasicObligation o, final BasicObligationNode oblNode, final Abortion aborter, final RuntimeInformation rti)
        ...
        if (BasicObligationCache.oblCache != null) {
            ...
            if (value != null) {
                switch (value) {
                    case YES:
                        return ResultFactory.proved(PTRS_SAST_ProblemProcessor.pIsCachedProof);
                    case NO:
                        return ResultFactory.disproved(PTRS_SAST_ProblemProcessor.pIsCachedProof);
                    default:
                        break;
                }
            }
    ...
    private static final class RisEmptyProof extends Proof {
        ...
        public String export(final Export_Util o, final VerbosityLevel level) {
            ...
            res.append(" SAST is trivially proven.");
