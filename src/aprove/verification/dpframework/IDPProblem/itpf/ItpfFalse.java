...
public class ItpfFalse extends ItpfAtom {

    public static final ItpfFalse FALSE = new ItpfFalse();
    ...
    public Itpf visit(IItpfVisitor visitor) {
        return visitor.fcaseFalse(this) ? visitor.caseFalse(this) : this;
    }
