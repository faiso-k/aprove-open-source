...
public class NewTypeReductionProcessor extends HaskellProcessor {
    ...
    public Result process(HaskellProgram obj, Abortion aborter) {
        ...
        NewTypeReductionProof proof = new NewTypeReductionProof(obj, hp);
        if (NewTypeReduction.applyTo(hp.getModules(),proof,aborter)) {
            // XXX DEBUG
            if (aprove.Globals.DEBUG_SWISTE || aprove.Globals.DEBUG_MATRAF) {
                System.out.println("NewType Reduction does");
            }
            ...
            // XXX DEBUG
            if (aprove.Globals.DEBUG_SWISTE || aprove.Globals.DEBUG_MATRAF) {
                System.out.println("NewType Reduction fail");
            }
