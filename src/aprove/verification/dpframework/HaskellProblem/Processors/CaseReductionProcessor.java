 ...
 */
@NoParams
public class CaseReductionProcessor extends HaskellProcessor {
    ...
    public Result process(HaskellProgram obj, Abortion aborter) {
        ...
        CaseReductionProof proof = new CaseReductionProof(obj, hp);
        if (CaseReduction.applyTo(hp.getModules(),proof,aborter)) {
            // XXX DEBUG
            if (aprove.Globals.DEBUG_SWISTE || aprove.Globals.DEBUG_MATRAF) {
                System.out.println("Case Reduction does");
            }
            ...
            // XXX DEBUG
            if (aprove.Globals.DEBUG_SWISTE || aprove.Globals.DEBUG_MATRAF) {
                System.out.println("Case Reduction fail");
            }
