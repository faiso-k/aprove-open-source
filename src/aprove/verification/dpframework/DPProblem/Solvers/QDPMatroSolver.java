...
/**
 * QDP Matrix order processor. Tries to orient P and all usable rules of P non-strictly
 ...
 * @version $Id$
 */
public class QDPMatroSolver implements QActiveSolver {

    private MATROFactory factory;

    public QDPMatroSolver(MATROFactory factory) {
