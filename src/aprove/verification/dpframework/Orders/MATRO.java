...
public class MATRO extends AbstractMATRO {
    ...
    private MATRO(final SymbolRepresentations representation, final TermInterpretor ti, final Map<String, BigInteger> result, final Map<Constraint<TRSTerm>, Collection<Constraint<TRSTerm>>> hardCodedRelations, final ActiveResolver activeResolver) {
     ...
     */
    public static MATRO create(final SymbolRepresentations representation, final TermInterpretor ti, final Map<String, BigInteger> result, final Map<Constraint<TRSTerm>, Collection<Constraint<TRSTerm>>> hardCodedRelations, final ActiveResolver activeResolver) {
        return new MATRO(representation, ti, result, hardCodedRelations, activeResolver);
    }
    ...
    public boolean areEquivalent(final TRSTerm s, final TRSTerm t) {
        ...
        return leftM.isGE(rightM) && !leftM.isGT(rightM);
    }
