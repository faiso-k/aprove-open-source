...
public class NonMonCand2Heuristic implements NonMonInterHeuristic {
    ...
    private Cand1MMInterHeuristic mmHeur;


    public NonMonCand2Heuristic() {
        this.mmHeur = new Cand1MMInterHeuristic();
    }
    ...
    public Collection<Pair<Integer, Integer>> getMaxCombinations(FunctionSymbol f) {
        return this.mmHeur.getMaxCombinations(f);
    }

    @Override
    public Collection<Pair<Integer, Integer>> getMinCombinations(FunctionSymbol f) {
        return this.mmHeur.getMinCombinations(f);
    }
