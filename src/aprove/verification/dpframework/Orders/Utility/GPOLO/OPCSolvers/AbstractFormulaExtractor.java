 ...
 * @author cotto
 */
public abstract class AbstractFormulaExtractor<C extends GPolyCoeff>
     ...
     */
    private FormulaFactory<Diophantine> formulaFactory =
        new FullSharingFlatteningFactory<Diophantine>();

    /**
     * Collect all the constraints.
     */
    private Formula<Diophantine> formula =
     ...
     */
    private Stack<Formula<Diophantine>> backup =
        new Stack<Formula<Diophantine>>();
     ...
     */
    protected void buildNot(final Formula<Diophantine> sub) {
     ...
     */
    protected void buildAnd(
            final Formula<Diophantine> a,
            final Formula<Diophantine> b) {
     ...
     */
    protected FormulaFactory<Diophantine> getFormulaFactory() {
