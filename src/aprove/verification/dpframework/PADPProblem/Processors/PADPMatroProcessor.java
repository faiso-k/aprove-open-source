...
public class PADPMatroProcessor extends PADPProcessor {
    ...
    public PADPMatroProcessor(PADPMatroProcessor.Arguments arguments) {
    ...
    protected boolean cannotBeUsed(PADPProblem padp) {
        return !this.isPA(padp.getP(), padp.getSortMap(), padp.getDefTup()) && this.containsBaseFun(padp.getSortMap());
    }
    ...
    protected Result processPADP(PADPProblem padp, Abortion aborter) throws AbortionException {
        ...
        if (solution == null) {
            ...
            Proof proof = new PADPMatroProof(deletedP, interp, useable);
    ...
    /*************************************************************************/
    private static class PADPMatroProof extends Proof.DefaultProof {

        private Set<PARule> deletedP;
        private MatrixInterpretation interp;
        private PATRSProblem useable;

        public PADPMatroProof(Set<PARule> deletedP, MatrixInterpretation interp, PATRSProblem useable) {
