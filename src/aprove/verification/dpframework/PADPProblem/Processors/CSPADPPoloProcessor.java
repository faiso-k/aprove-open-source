...
public class CSPADPPoloProcessor extends CSPADPProcessor {

    protected final BigInteger range;
    protected final boolean noIntDependence;

    @ParamsViaArgumentObject
    public CSPADPPoloProcessor(Arguments arguments) {
    ...
    protected Result processCSPADP(CSPADPProblem cspadp, Abortion aborter) throws AbortionException {
        ...
        if (solution == null) {
            ...
            Proof proof = new CSPADPPoloProof(deletedP, interp, useable);
    ...
    /*************************************************************************/
    private static class CSPADPPoloProof extends Proof.DefaultProof {

        private Set<PARule> deletedP;
        private LinearInterpretation interp;
        private CSPATRSProblem useable;

        public CSPADPPoloProof(Set<PARule> deletedP, LinearInterpretation interp, CSPATRSProblem useable) {
