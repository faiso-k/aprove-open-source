...
public class CSPADPMonotonicPoloProcessor extends CSPADPPoloProcessor {
    ...
    protected Result processCSPADP(CSPADPProblem cspadp, Abortion aborter) throws AbortionException {
        ...
        if (solution == null) {
            ...
            Proof proof = new CSPADPMonotonicPoloProof(deletedP, deletedR, interp, useable);
    ...
    private static class CSPADPMonotonicPoloProof extends Proof.DefaultProof {
        ...
        public CSPADPMonotonicPoloProof(Set<PARule> deletedP, Set<PARule> deletedR, LinearInterpretation interp, CSPATRSProblem useable) {
