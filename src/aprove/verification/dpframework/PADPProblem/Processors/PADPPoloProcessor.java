...
public class PADPPoloProcessor extends PADPProcessor {
    ...
    public PADPPoloProcessor(PADPPoloProcessor.Arguments arguments) {
    ...
    protected Result processPADP(PADPProblem padp, Abortion aborter) throws AbortionException {
        ...
        if (solution == null) {
            ...
            Proof proof = new PADPPoloProof(deletedP, interp, useable);
    ...
    private static class PADPPoloProof extends Proof.DefaultProof {
        ...
        public PADPPoloProof(Set<PARule> deletedP, LinearInterpretation interp, PATRSProblem useable) {
        ...
        public String export(Export_Util o, VerbosityLevel level) {
            ...
            result.append("Using a PA-polynomial interpretation, ");
