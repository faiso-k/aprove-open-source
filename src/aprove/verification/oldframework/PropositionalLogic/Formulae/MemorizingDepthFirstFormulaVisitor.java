...
public class MemorizingDepthFirstFormulaVisitor<T> implements FormulaVisitor<Object, T> {

    protected Set<Formula<T>> visited = new HashSet<Formula<T>>();
    ...
    protected void outConstant(Constant<T> f) {}
    ...
    protected void outVariable(Variable<T> f) {}
