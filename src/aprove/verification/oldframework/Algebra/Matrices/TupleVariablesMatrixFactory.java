 ...
 */
public class TupleVariablesMatrixFactory extends AbstractMatrixFactory {
    ...
    public TupleVariablesMatrixFactory(Arguments arguments) {
        this.filter = arguments.filter;
        this.dimension = arguments.size;
    }

    private TupleVariablesMatrixFactory(int dimension, MatrixFilter filter) {
    ...
    public MatrixFactory duplicateSelf() {
        ...
        return new TupleVariablesMatrixFactory(this.dimension, this.filter);
