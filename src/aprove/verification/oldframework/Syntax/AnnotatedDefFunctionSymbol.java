...
/**
 * A <code>DefFunctionSymbol</code> which can hold additional
 ...
 * @version $Id$
 */
public class AnnotatedDefFunctionSymbol extends DefFunctionSymbol implements AnnotatedFunctionSymbol, PrettyStringable {
    ...
    /**
     * Creates a new <code>AnnotatedDefFunctionSymbol</code> instance,
     ...
     */
    public AnnotatedDefFunctionSymbol(String name, List<Sort> argsorts, Sort sort) {
     ...
     * @see ConstructorSymbol
     */
    public AnnotatedDefFunctionSymbol(String name, List<Sort> argsorts, Sort sort, Object annotation) {
    ...
    if (obj instanceof SyntacticFunctionSymbol) {
        ...
        if (symbol instanceof AnnotatedDefFunctionSymbol) {
        return (symbol.getName().equals(this.getName()) && ((AnnotatedDefFunctionSymbol) obj).annotation.equals(this.annotation));
        } else {
