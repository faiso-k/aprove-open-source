...
/** Implementation of a multiset of AC-terms.
 *
...
public class MultisetOfACTerms {
    ...
    /** Returns a new instance of <code>MultisetOfACTerms</code>.
     */
     ...
     */
    public void add(final ACTerm o) {
        this.add(o, 1);
    }
     ...
     * this multiset.
     */
    public void add(final ACTerm o, int occ) {
     ...
     */
    public void remove(final ACTerm o) {
        final ACTerm m = this.getRep(o);
        if (m != null) {
     ...
     */
    public void removeAll(final ACTerm o) {
        final ACTerm m = this.getRep(o);
        if (m != null) {
            this.multiset.remove(m);
        }
    ...
    public MultisetOfACTerms union(final MultisetOfACTerms other) {
        final MultisetOfACTerms res = this.deepcopy();
        Enumeration e;
        ACTerm o;

        e = other.elements();
        while (e.hasMoreElements()) {
            o = (ACTerm) e.nextElement();
    ...
    public MultisetOfACTerms intersect(final MultisetOfACTerms other) {
        final MultisetOfACTerms res = MultisetOfACTerms.create();
        Enumeration e;
        ACTerm o;
        int occ1, occ2;
        int occ;
    ...
    public int realSize() {
        ...
        while (e.hasMoreElements()) {
            res += this.numberOfOccurences((ACTerm) e.nextElement());
        }
        return res;
    }
