...
/**
 * Represents a formula that is always wrong.
...
public class FalseFormula<A extends CheckableAndSMTExportable> extends AbstractFormula<A> {
    ...
    public Formula<SMTLIBTheoryAtom> toSMTLIBInt(final FormulaFactory<SMTLIBTheoryAtom> factory) {
        ...
        return factory.buildTheoryAtom(SMTLIBIntGT.create(smtLibZero, smtLibZero));
    }
    ...
    public Formula<SMTLIBTheoryAtom> toSMTLIBRat(final FormulaFactory<SMTLIBTheoryAtom> factory) {
        ...
        return factory.buildTheoryAtom(SMTLIBRatGT.create(smtLibZero, smtLibZero));
    }
