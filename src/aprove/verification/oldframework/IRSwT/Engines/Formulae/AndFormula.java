...
public class AndFormula<A extends CheckableAndSMTExportable> extends TwoAryFormula<A> {
     ...
     */
    public AndFormula(final AbstractFormula<A> leftForm, final AbstractFormula<A> rightForm) {
    ...
    public Formula<SMTLIBTheoryAtom> toSMTLIBInt(final FormulaFactory<SMTLIBTheoryAtom> factory) {
        return factory.buildAnd(this.left.toSMTLIBInt(factory), this.right.toSMTLIBInt(factory));
    }

    @Override
    public Formula<SMTLIBTheoryAtom> toSMTLIBRat(final FormulaFactory<SMTLIBTheoryAtom> factory) {
        return factory.buildAnd(this.left.toSMTLIBRat(factory), this.right.toSMTLIBRat(factory));
    }
