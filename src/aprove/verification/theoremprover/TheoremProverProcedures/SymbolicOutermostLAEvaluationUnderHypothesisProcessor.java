...
public class SymbolicOutermostLAEvaluationUnderHypothesisProcessor extends
        TheoremProverProcessor {

    private final boolean hypothesesOutermostApplication;

    @ParamsViaArguments("HypothesesOutermostApplication")
    public SymbolicOutermostLAEvaluationUnderHypothesisProcessor(boolean hypothesesOutermostApplication) {
        this.hypothesesOutermostApplication = hypothesesOutermostApplication;
    }
    ...
    protected Formula evaluate(Program program, Formula formula,
        ...
        if (!hypotheses.isEmpty()) {
            if(this.hypothesesOutermostApplication){
                newFormula = FormulaOutermostEvaluationUnderHypothesisVisitor.apply(program,
                        newFormula, hypotheses, true);
            }
            else {
        ...
        newFormula = FormulaOutermostLAEvaluationVisitor.apply(newFormula, program);

//        if (!hypotheses.isEmpty()) {
//            if(hypothesesOutermostApplication){
//                newFormula = FormulaOutermostEvaluationUnderHypothesisVisitor.apply(program,
//                        newFormula, hypotheses, true);
//            }
//            else {
