...
public class SymbolicEvaluationUnderHypothesisProof extends TheoremProverProof {
    ...
    public SymbolicEvaluationUnderHypothesisProof(TheoremProverObligation newObligation, Set<HypothesisPair> hypotheses ) {
    ...
    public String export(Export_Util o) {
        ...
        if(this.hypotheses.isEmpty()) {
            stringBuffer.append(o.bold("Could be reduce to "+o.export(FormulaTruthValue.TRUE)+" due to an inconsistent hypotheses set."));
        }else if(this.newObligation.getFormula().equals(FormulaTruthValue.TRUE) ) {
            stringBuffer.append(o.bold("Could be shown using symbolic evaluation under hypothesis, by using the following hypotheses:"));
            stringBuffer.append(o.paragraph());
        } else if(this.newObligation.getFormula().equals(FormulaTruthValue.FALSE)) {
            stringBuffer.append(o.bold("Could be disproved using symbolic evaluation under hypothesis, by using the following hypotheses:"));
            stringBuffer.append(o.paragraph());
        } else {
            stringBuffer.append(o.bold("Could be reduced by symbolic evaluation under hypothesis to:"));
    ...
    public Proof deepcopy() {
        ...
        return new SymbolicEvaluationUnderHypothesisProof(this.newObligation.deepcopy(), hypotheses);
    }
