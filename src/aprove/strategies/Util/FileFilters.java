...
public class FileFilters extends javax.swing.filechooser.FileFilter implements java.io.FileFilter {
    ...
    public static Vector createFor(String name){
    ...
    public FileFilters(String type) {
        ...
        if (this.suffixes == null) {
            throw new RuntimeException("FileFilters: filetype "+type+" unknown");
        }
    ...
    private static void loadProperties() {
            FileFilters.type2desc = new HashMap();
            FileFilters.type2exts = new HashMap();
            FileFilters.name2types = new HashMap();
            Properties defaultprops = new Properties();
            try {
                PropertyLoader.fromResource(defaultprops, FileFilters.class, "filefilters.properties");
            } catch (IOException e) {
