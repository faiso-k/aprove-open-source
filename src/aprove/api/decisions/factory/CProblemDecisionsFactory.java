...
public enum CProblemDecisionsFactory {
    ;
    ...
    public static Optional<ProblemDecisions>
        ...
        return ProblemDecisionsImpl.create(new AnalyzableProblemInputCreator(problemInput,
                                                                     CProblemDecisionsFactory::belongsToProtoAnnotation,
                                                                     CProblemDecisionsFactory::toProtoAnnotation),
    ...
    private static String toProtoAnnotation(ProblemDecisionResults problemDecisionResults) {
        return HANDLING_MODES.get(problemDecisionResults.getHandlingMode()).substring(2)
               + problemDecisionResults.getQuery();
    }
}
