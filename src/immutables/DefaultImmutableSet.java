...
/**
 * Default implementation for immutable sets, useful for creating
 * immutable sets for sets which do not have an immutable class
 * of their own. However, you can only use the (non-destructive)
 * methods which are specified by Set<E>.
 *
 * @author Peter Schneider-Kamp
 * @version $Id$
 * @param <E> The type of elements in this set.
 */
class DefaultImmutableSet<E> implements ImmutableSet<E> {
     ...
     * @param referenceSet The Set to be made immutable.
     * @return An immutable version of the specified Set.
     */
    static <U> DefaultImmutableSet<U> create(DefaultImmutableSet<U> referenceSet) {
        return referenceSet;
    }
     ...
     * @return An immutable version of the specified Set.
     */
    static <U> DefaultImmutableSet<U> create(Set<U> referenceSet) {
        return new DefaultImmutableSet<U>(referenceSet);
    }
    ...
    /**
     * @param reference Set to be made immutable.
     */
    private DefaultImmutableSet(Set<E> reference) {
        this.set = reference;
